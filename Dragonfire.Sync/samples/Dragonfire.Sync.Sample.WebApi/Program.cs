...
using Dragonfire.Sync.Core.DependencyInjection;
using Dragonfire.Sync.EntityFrameworkCore;
using Dragonfire.Sync.Sample.WebApi;
using Dragonfire.Sync.Sample.WebApi.Sync;
...
// Dragonfire.Sync core + EF Core state store.
...
// registration — Dragonfire.Sync never assumes how the client is constructed (HTTP,
...
app.MapPost("/sync/{providerName}/{streamName}/run", async (string providerName, string streamName, Dragonfire.Sync.Core.ISyncOrchestrator orch, CancellationToken ct) =>
{
