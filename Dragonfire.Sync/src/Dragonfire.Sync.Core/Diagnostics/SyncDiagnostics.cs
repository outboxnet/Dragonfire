...
namespace Dragonfire.Sync.Core.Diagnostics;

/// <summary>
/// Static <see cref="ActivitySource"/> and <see cref="Meter"/> used by Dragonfire.Sync.
...
public static class SyncDiagnostics
{
    ...
    public const string SourceName = "Dragonfire.Sync";
