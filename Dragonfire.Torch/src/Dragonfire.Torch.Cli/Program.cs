...
using Dragonfire.Torch;

var inputOption = new Option<FileInfo>(
    aliases: new[] { "--input", "-i" },
    description: "Path to the input file. Accepts a Postman v2.1 collection (.json) or an HTTP Archive (.har).")
    { IsRequired = true };
...
var root = new RootCommand("Generate a typed C# HTTP client from a Postman v2.1 collection or an HTTP Archive (.har) file.")
{
    inputOption,
    outputOption,
    namespaceOption,
