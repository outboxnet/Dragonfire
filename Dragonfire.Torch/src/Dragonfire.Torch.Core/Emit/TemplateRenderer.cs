...
/// <c>Dragonfire.Torch.Core/Templates/*.sbn</c> and are embedded via
...
public sealed class TemplateRenderer
{
    ...
    public TemplateRenderer()
    {
        ...
        // "Dragonfire.Torch" so templates show up as
        // "Dragonfire.Torch.Templates.<File>.sbn".
        _resourcePrefix = "Dragonfire.Torch.Templates.";
    }
