...
using Dragonfire.Inbox.Providers.Extensions;
using Dragonfire.Inbox.SampleApp.Handlers;
using Dragonfire.Inbox.SampleApp.Providers.Acme;
...
// Health probe.
app.MapGet("/", () => Results.Ok(new { service = "Dragonfire.Inbox.SampleApp", status = "ok" }));
