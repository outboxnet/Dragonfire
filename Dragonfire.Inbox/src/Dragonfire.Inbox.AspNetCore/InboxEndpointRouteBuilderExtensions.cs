...
using Dragonfire.Inbox.Observability;
using Dragonfire.Inbox.Options;

namespace Dragonfire.Inbox.AspNetCore;
...
public static class InboxEndpointRouteBuilderExtensions
{
    ...
    private static async Task<IResult> HandleAsync(HttpContext context, string providerKey)
    {
        ...
        var logger = sp.GetRequiredService<ILoggerFactory>().CreateLogger("Dragonfire.Inbox.Webhook");
