...
using Dragonfire.Inbox.Processor;

namespace Dragonfire.Inbox.AzureFunctions.Extensions;

public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Registers the Dragonfire.Inbox pipeline for Azure Functions Isolated Worker.
    /// <para>
