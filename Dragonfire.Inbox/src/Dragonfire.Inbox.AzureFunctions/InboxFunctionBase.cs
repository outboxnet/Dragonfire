...
namespace Dragonfire.Inbox.AzureFunctions;
...
///         [TimerTrigger("%Dragonfire.Inbox:DispatchCron%")] TimerInfo _,
///         CancellationToken ct)
///         => DispatchAsync(ct);
/// }
/// </code>
/// <para>
/// Set <c>Dragonfire.Inbox:DispatchCron</c> in <c>local.settings.json</c> (or Azure App Settings)
