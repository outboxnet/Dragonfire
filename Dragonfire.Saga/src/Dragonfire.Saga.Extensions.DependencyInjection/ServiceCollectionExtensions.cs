...
using Dragonfire.Saga.Core.Engine;
using Dragonfire.Saga.Core.Events;
using Dragonfire.Saga.Core.Middleware;
using Dragonfire.Saga.Core.Models;
using Dragonfire.Saga.Core.Registry;

namespace Dragonfire.Saga.Extensions.DependencyInjection;

/// <summary>
/// Extension methods for registering Dragonfire.Saga into an <see cref="IServiceCollection"/>.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds the Dragonfire.Saga workflow engine to the DI container.
    /// </summary>
    /// <example>
    /// <code>
    ...
    /// <summary>
    /// Adds a Dragonfire.Saga health check that reports Healthy when the host is running.
    /// </summary>
