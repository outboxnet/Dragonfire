...
///     --project src/Dragonfire.Saga.Persistence.EfCore \
///     --startup-project src/Dragonfire.Saga.Persistence.EfCore
///
/// dotnet ef database update \
///     --project src/Dragonfire.Saga.Persistence.EfCore \
///     --startup-project src/Dragonfire.Saga.Persistence.EfCore \
///     --connection "Server=.;Database=Dragonfire.Saga;Trusted_Connection=True;"
/// </code>
/// </summary>
public sealed class SagaNetDbContextFactory : IDesignTimeDbContextFactory<SagaNetDbContext>
{
    public SagaNetDbContext CreateDbContext(string[] args)
    {
        ...
        var connectionString =
            ...
            ?? "Server=(localdb)\\mssqllocaldb;Database=Dragonfire.Saga;Trusted_Connection=True;MultipleActiveResultSets=true";
