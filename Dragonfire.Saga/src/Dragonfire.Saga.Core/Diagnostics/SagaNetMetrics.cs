...
namespace Dragonfire.Saga.Core.Diagnostics;

/// <summary>
/// OpenTelemetry instrumentation for Dragonfire.Saga.
...
{
    public const string ActivitySourceName = "Dragonfire.Saga";
    public const string MeterName = "Dragonfire.Saga";
